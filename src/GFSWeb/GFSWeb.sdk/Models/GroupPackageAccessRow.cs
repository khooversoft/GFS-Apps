...
public record GroupPackageAccessRow
{
    public string PackageId { get; init; } = null!;
    public string GroupName { get; init; } = null!;
    public string Role { get; init; } = null!;

    public static IValidator<GroupPackageAccessRow> Validator { get; } = new Validator<GroupPackageAccessRow>()
...
public static class GroupPackageAccessRecordTool
{
    ...
    public static Option Validate(this GroupPackageAccessRow subject) => GroupPackageAccessRow.Validator.Validate(subject).ToOptionStatus();
}
