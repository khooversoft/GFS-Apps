...
namespace Elim.Sap.Testing.QueryTests;
...
public class SimpleQuery
{
    ...
    public void Query_ReturnsMultipleRows_AllDeserialized()
    {
        var function = new FakeSapFunction()
            .WithResultRow(new Dictionary<string, string>
            {
                ["CO"] = "2008", ["DOC_NO"] = "100000001", ["GL"] = "4100000", ["LC_AMT"] = "100.00", ["PERIOD"] = "1",
            })
            .WithResultRow(new Dictionary<string, string>
            {
                ["CO"] = "2008", ["DOC_NO"] = "100000002", ["GL"] = "4200000", ["LC_AMT"] = "200.00", ["PERIOD"] = "2",
            })
            .WithResultRow(new Dictionary<string, string>
            {
                ["CO"] = "3010", ["DOC_NO"] = "100000003", ["GL"] = "4300000", ["LC_AMT"] = "-300.00", ["PERIOD"] = "3",
            });
    ...
    public void Query_MultipleRangeParameters_EachGetsOwnTable()
    {
        var function = new FakeSapFunction()
            .WithResultRow(new Dictionary<string, string>
            {
                ["CO"] = "2008", ["DOC_NO"] = "400000001", ["GL"] = "4100000", ["LC_AMT"] = "0", ["PERIOD"] = "1",
            });
    ...
    public void Query_NoParameters_InvokesFunctionWithNoInputs()
    {
        var function = new FakeSapFunction()
            .WithResultRow(new Dictionary<string, string>
            {
                ["CO"] = "1000", ["DOC_NO"] = "X", ["GL"] = "Y", ["LC_AMT"] = "0", ["PERIOD"] = "0",
            });
